...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.node_lb.setText(_translate("Form", "WD Node"))
        self.node_combo.setItemText(0, _translate("Form", "New"))
        self.nodeSelect_btn.setToolTip(_translate("Form", "Select"))
        self.nodeSave_btn.setToolTip(_translate("Form", "Export"))
        self.nodeOpen_btn.setToolTip(_translate("Form", "Import"))
        self.driver_lb.setText(_translate("Form", "Driver Joint"))
        self.driver_le.setPlaceholderText(_translate("Form", "Select one driver joint."))
        self.driverSelect_btn.setToolTip(_translate("Form", "Select"))
        self.parent_lb.setText(_translate("Form", "Parent"))
        self.parentSelect_btn.setToolTip(_translate("Form", "Select"))
        self.contrl_lb.setText(_translate("Form", "Controller"))
        self.controlSelect_btn.setToolTip(_translate("Form", "Select"))
        self.allow_cb.setText(_translate("Form", "Allow Negative"))
        self.checkBox.setText(_translate("Form", "Show Icon"))
        self.label.setText(_translate("Form", "Twist Axis"))
        ...
        self.mode_lb.setText(_translate("Form", "Mode"))
