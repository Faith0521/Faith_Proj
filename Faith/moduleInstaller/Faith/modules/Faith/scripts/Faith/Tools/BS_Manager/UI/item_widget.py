...
class Ui_tab_main(object):
    def setupUi(self, tab_main):
        ...
        self.mirror_tgt_btn = MPushButton().small()
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.startAdd_btn = QtWidgets.QPushButton(self.drive_widget)
...
"}")
        ...
        self.endAdd_btn = QtWidgets.QPushButton(self.drive_widget)
...
"}")
        ...
        self.apply_btn = MPushButton().small()
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.mirror_btn = MPushButton().small()
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, tab_main):
        ...
        self.axis_lb.setText(u"方向")
        self.x_rb.setText(_translate("tab_main", "X"))
        self.y_rb.setText(_translate("tab_main", "Y"))
        self.z_rb.setText(_translate("tab_main", "Z"))
        self.name_lb.setText(u"通道命名")
        self.name_le.setPlaceholderText(u"镜像的通道名称")
        self.mirror_tgt_btn.setText(u"镜像目标体")
        self.driver_lb.setText(u"驱动物体")
        self.driver_le.setPlaceholderText(u"选择一个驱动属性")
        self.driver_btn.setToolTip(u"选择")
        self.attr_lb.setText(u"属性")
        self.attr_combo.setItemText(0, _translate("tab_main", "None"))
        self.time_lb.setText(u"开始/结束")
        self.startAdd_btn.setToolTip(u"设置")
        self.endAdd_btn.setToolTip(u"设置")
        ...
        self.apply_btn.setText(u"创建")
        self.mirror_btn.setText(u"镜像")
        self.label.setText(u"左侧")
