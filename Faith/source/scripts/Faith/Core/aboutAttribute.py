...
# @Last Modified time: 2022-05-14 18:56:46
...
from .aboutPy import string_types
...
class AttrDef(object):
    ...
    Example:
     ...
     Arguments:
        attributeName (str): Attribute fullName
    ...
    def get_as_dict(self):
        ...
        self.attr_dict["attributeName"] = self.attrName
    ...
    def set_from_dict(self, param_dict):
        ...
        self.attrName = param_dict["attributeName"]
...
class AttrDef2(AttrDef):
    """ParamDef2 inherit from ParamDef

    Arguments:
        attributeName (str): Parameter scriptname.
    ...
    Returns:
        AttrDef: The stored parameter definition.
...
class FCurveAttrDef(AttrDef):
    ...
    def create(self, node):
        ...
        """
        attr_name = addAttribute(node, self.attrName, "double", 0)

        attrDummy_name = addAttribute(
            node, self.attrName + "_dummy", "double", 0)
...
class colorParamDef(AttrDef):
    ...
    def get_as_dict(self):
        ...
        self.attr_dict["scriptName"] = self.scriptName
        self.attr_dict["value"] = self.value
