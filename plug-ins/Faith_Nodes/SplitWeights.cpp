...
MString SplitWeights::NodeName = "FAITH_SplitWeights";
MTypeId SplitWeights::NodeID = MTypeId(0x0118);

MObject SplitWeights::active;
MObject SplitWeights::alpha;
MObject SplitWeights::colorR;
MObject SplitWeights::colorG;
MObject SplitWeights::colorB;
MObject SplitWeights::colorA;
MObject SplitWeights::curve;
MObject SplitWeights::curveRamp;
MObject SplitWeights::curveRampUVal;
MObject SplitWeights::globalInfluenceScale;
MObject SplitWeights::globalRadius;
MObject SplitWeights::globalScale;
MObject SplitWeights::influence;
MObject SplitWeights::inputComponentsList;
MObject SplitWeights::inputComponents;
MObject SplitWeights::inputTransfer;
MObject SplitWeights::invert;
MObject SplitWeights::invertList;
MObject SplitWeights::matrix;
MObject SplitWeights::matrixList;
MObject SplitWeights::mesh;
MObject SplitWeights::outputTransfer;
MObject SplitWeights::radius;
MObject SplitWeights::restParentMatrix;
MObject SplitWeights::scale;
MObject SplitWeights::texture;
MObject SplitWeights::transferWeights;
MObject SplitWeights::useShape;
MObject SplitWeights::useTransfer;
MObject SplitWeights::useUV;
MObject SplitWeights::weights;
MObject SplitWeights::weightList;
MObject SplitWeights::worldSpace;
